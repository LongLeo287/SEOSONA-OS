...
## Your mission
Update an existing skill or its reference files in `.agent/skills/${SKILL}` directory based on the user's prompt. 
...
## IMPORTANT NOTES:
- ALWAYS make changes to skills in the project-scope `.agent/skills/` directory (UNLESS you're allowed to).
- DO NOT make any changes to skills in the home/user-scope `~/.agent/skills/` directory (UNLESS you're allowed to).
