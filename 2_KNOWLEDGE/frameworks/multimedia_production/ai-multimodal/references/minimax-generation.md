...
Base URL: `http~/.seosona/path/` | Auth: `Bearer {MINIMAX_API_KEY}`
...
```json
POST /voice_clone
{"audio_url": "http~/.seosona/path/", "clone_name": "my_voice"}
```
...
- [API Overview](http~/.seosona/path/)
- [Video Guide](http~/.seosona/path/)
- [Speech API](http~/.seosona/path/)
- [Music API](http~/.seosona/path/)
