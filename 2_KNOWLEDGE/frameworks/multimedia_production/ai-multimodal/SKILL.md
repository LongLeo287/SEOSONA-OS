...
export GEMINI_API_KEY="your-key"  # http~/.seosona/path/
# MiniMax (image/video/speech/music gen)
export MINIMAX_API_KEY="your-key"  # http~/.seosona/path/
...
- [Gemini API Docs](http~/.seosona/path/)
- [Gemini Pricing](http~/.seosona/path/)
- [MiniMax API Docs](http~/.seosona/path/)
- [MiniMax Pricing](http~/.seosona/path/)
