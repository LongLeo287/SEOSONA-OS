...
source_video: "http~/.seosona/path/?v=..."
...
```bash
/youtube:blog "http~/.seosona/path/?v=xyz"
/youtube:blog "http~/.seosona/path/" casual
/youtube:blog "http~/.seosona/path/?v=123" professional
```
