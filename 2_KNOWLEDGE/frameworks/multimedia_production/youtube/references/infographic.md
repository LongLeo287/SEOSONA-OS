...
**IMPORTANT:** Embed tokens inline for fil~/.seosona/path/ compatibility. Run:
```bash
node .opencode/skills/design-system/scripts/embed-tokens.cjs --minimal
```
...
<head>
  ...
  <link href="http~/.seosona/path/?family=Space+Grotesk:wght@400;500;600;700&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
  <style>
...
```bash
/youtube:infographic "http~/.seosona/path/?v=xyz"
/youtube:infographic "http~/.seosona/path/" timeline
/youtube:infographic "http~/.seosona/path/?v=123" data
```
