---
name: seosona:video-audio-ingestion
...
- Upstream yt-dlp repository: `https://github.com/yt-dlp/yt-dlp`
- Upstream Whisper repository: `https://github.com/openai/whisper`
