...
# Version: 1.0 | Created: 2026-03-31 | SEOSONA OS OS
...
**2-Strike Rule:** Fail twice on same task -> set `handoff_trigger: BLOCKED`, stop, report to SEOSONA.
...
*Mcp Server Agent - Created by SEOSONA OS OS agent-auto-create workflow. Supervised until first performance review.*
