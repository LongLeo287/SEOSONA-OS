...
1. **Ask user which language they prefer:**
   - JavaScript (2_KNOWLEDGE/frameworks/apify-actor-development/references/actor-template-js.md)
   - TypeScript (2_KNOWLEDGE/frameworks/apify-actor-development/references/actor-template-ts.md)
   - Python (2_KNOWLEDGE/frameworks/apify-actor-development/references/actor-template-python.md)
...
2. Copy appropriate language template from `2_KNOWLEDGE/frameworks/apify-actor-development/references/` directory
...
- [2_KNOWLEDGE/frameworks/apify-actor-development/references/actor-json.md](2_KNOWLEDGE/frameworks/apify-actor-development/references/actor-json.md)
- [2_KNOWLEDGE/frameworks/apify-actor-development/references/input-schema.md](2_KNOWLEDGE/frameworks/apify-actor-development/references/input-schema.md)
- [2_KNOWLEDGE/frameworks/apify-actor-development/references/output-schema.md](2_KNOWLEDGE/frameworks/apify-actor-development/references/output-schema.md)
- [2_KNOWLEDGE/frameworks/apify-actor-development/references/dataset-schema.md](2_KNOWLEDGE/frameworks/apify-actor-development/references/dataset-schema.md)
- [2_KNOWLEDGE/frameworks/apify-actor-development/references/key-value-store-schema.md](2_KNOWLEDGE/frameworks/apify-actor-development/references/key-value-store-schema.md)
...
3. Implement standby mode readiness probe if `usesStandbyMode: true` (see [2_KNOWLEDGE/frameworks/apify-actor-development/references/standby-mode.md](2_KNOWLEDGE/frameworks/apify-actor-development/references/standby-mode.md))
4. Use proper logging (see [2_KNOWLEDGE/frameworks/apify-actor-development/references/logging.md](2_KNOWLEDGE/frameworks/apify-actor-development/references/logging.md))
