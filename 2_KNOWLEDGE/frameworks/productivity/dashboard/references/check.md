...
```bash
curl -s -o /dev/null -w "%{http_code}" htt~/.seosona/path/:3457/health 2>/dev/null || echo "offline"
```
...
```bash
curl -s -o /dev/null -w "%{http_code}" htt~/.seosona/path/:5173 2>/dev/null || echo "offline"
```
...
|-----------|------|--------|-----|
| Backend API | 3457 | {status} | htt~/.seosona/path/:3457 |
| Frontend | 5173 | {status} | htt~/.seosona/path/:5173 |
| Health | 3457 | {status} | htt~/.seosona/path/:3457/health |
...
Frontend: htt~/.seosona/path/:5173
API: htt~/.seosona/path/:3457
