...
Report the local URL to the user. Use `--host 0.0.0.0` only when the user explicitly authorizes LAN exposure, then use the `networkUrl` field from the JSON output.
...
Track progress: http~/.seosona/path/
