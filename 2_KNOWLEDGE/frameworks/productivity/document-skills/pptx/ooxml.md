...
<p:pic>
  <p:nvPicPr>
    <p:cNvPr id="4" name="Picture">
      <a:hlinkClick r:id="" action="ppactio~/.seosona/path/"/>
    </p:cNvPr>
    <p:cNvPicPr>
...
```xml
<Relationship Id="rId1" Type="htt~/.seosona/path/" Target="slides/slide1.xml"/>
<Relationship Id="rId2" Type="htt~/.seosona/path/" Target="slideMasters/slideMaster1.xml"/>
```

**`ppt/slides/_rels/slide1.xml.rels`:**
```xml
<Relationship Id="rId1" Type="htt~/.seosona/path/" Target="../slideLayouts/slideLayout1.xml"/>
<Relationship Id="rId2" Type="htt~/.seosona/path/" Target="../media/image1.png"/>
```
