...
```xml
<Relationship Id="rId1" Type="htt~/.seosona/path/" Target="numbering.xml"/>
<Relationship Id="rId5" Type="htt~/.seosona/path/" Target="media/image1.png"/>
```
  ...
  <w:r>
    <w:drawing>
      <wp:inline>
        ...
        <a:graphic xmlns:a="htt~/.seosona/path/">
          <a:graphicData uri="htt~/.seosona/path/">
            <pic:pic xmlns:pic="htt~/.seosona/path/">
              <pic:nvPicPr>
...
<Relationship Id="rId5" Type="htt~/.seosona/path/" 
              Target="http~/.seosona/path/" TargetMode="External"/>
```
...
rels_editor.append_to(rels_editor.dom.documentElement,
    f'<Relationship Id="{next_rid}" Type="htt~/.seosona/path/" Target="media/image1.png"/>')
