...
name: "humanizer"
description: "A skill for Claude Code and OpenCode that removes signs of AI-generated writing from text, making it sound more natural and human."
keywords: ["humanizer", "ingested"]
mcp_compatible: true
---
...
git clone http~/.seosona/path/ ~/.claude/skills/humanizer
```
...
git clone http~/.seosona/path/ ~/.config/opencode/skills/humanizer
```
...
Based on [Wikipedia's "Signs of AI writing"](http~/.seosona/path/:Signs_of_AI_writing) guide, maintained by WikiProject AI Cleanup. This comprehensive guide comes from observations of thousands of instances of AI-generated text.
...
- [Wikipedia: Signs of AI writing](http~/.seosona/path/:Signs_of_AI_writing) - Primary source
- [WikiProject AI Cleanup](http~/.seosona/path/:WikiProject_AI_Cleanup) - Maintaining organization
