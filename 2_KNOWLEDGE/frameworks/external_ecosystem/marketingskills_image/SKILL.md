---
name: "image"
description: "Skill from marketingskills"
keywords: ["image", "ingested"]
mcp_compatible: true
---
...
|-------|----------|:-:|-----|------|
| **Gemini Image** (Google, "Nano Banana" / Nano Banana Pro) | All-around, editing, multi-image reference, text rendering | Good | [Gemini API](http~/.seosona/path/) | Check [pricing](http~/.seosona/path/) |
| **Flux** (Black Forest Labs — Pro 1.1, Kontext, Dev, Schnell) | Photorealism, brand consistency, batch; Kontext for in-image editing | Limited | [BFL API](http~/.seosona/path/), Replicate, fal.ai | Check [pricing](http~/.seosona/path/) |
| **Ideogram 3.0** | Typography, branded graphics, accurate text rendering | Best | [Ideogram API](http~/.seosona/path/) | Check [pricing](http~/.seosona/path/) |
| **ChatGPT Images 2.0 / GPT Image** (OpenAI) | General purpose, ChatGPT integration, native editing | Good | [OpenAI API](http~/.seosona/path/) | Check [pricing](http~/.seosona/path/) |
| **Midjourney v7** | Artistic, high-aesthetic, art-directed visuals | Improved | No official API; Discord + Web | Subscription-based |
| **Recraft V3** | Vector + brand-consistent illustrations, design assets | Strong | [Recraft API](http~/.seosona/path/) | Per-credit |
...
curl -s http~/.seosona/path/ | grep -oP 'src="[^"]+\.(jpg|png|webp)"' | head -20
```
...
```html
<meta property="og:image" content="http~/.seosona/path/" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="630" />
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:image" content="http~/.seosona/path/" />
```
