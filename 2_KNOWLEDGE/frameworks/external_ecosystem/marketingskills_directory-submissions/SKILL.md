...
keywords: ["directory-submissions", "ingested"]
mcp_compatible: true
---
...
6. Once live, verify the backlink exists and is dofollow: `curl -sIL http~/.seosona/path/ | grep -i rel=`. If absent, the link is dofollow.
