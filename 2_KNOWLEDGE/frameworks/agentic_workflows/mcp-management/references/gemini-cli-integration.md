...
**Screenshot Capture**:
```bash
echo "Take a screenshot of http~/.seosona/path/" | gemini -y -m gemini-2.5-flash
```
...
**Browser Automation**:
```bash
echo "Navigate to http~/.seosona/path/, click the signup button, and take a screenshot" | gemini -y -m gemini-2.5-flash
```
...
- [Gemini CLI Documentation](http~/.seosona/path/)
- [MCP Server Configuration](http~/.seosona/path/)
- [Tool Reference](http~/.seosona/path/#tool-interaction)
