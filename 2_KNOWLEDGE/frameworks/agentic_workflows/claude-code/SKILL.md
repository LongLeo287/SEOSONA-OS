...
- Context7 llms.txt: `http~/.seosona/path/?tokens=10000`
- Topic search: `http~/.seosona/path/?topic=<topic>&tokens=5000`
- Official docs: http~/.seosona/path/
- GitHub: http~/.seosona/path/
