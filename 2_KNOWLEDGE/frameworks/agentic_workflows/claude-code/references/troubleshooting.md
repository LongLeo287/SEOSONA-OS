...
export HTTP_PROXY=htt~/.seosona/path/:8080
export HTTPS_PROXY=htt~/.seosona/path/:8080
export NO_PROXY=localhost,127.0.0.1

# Configure in settings
claude config set proxy htt~/.seosona/path/:8080

# Test connection
curl -x $HTTP_PROXY http~/.seosona/path/
```
...
1. **Check existing issues**: http~/.seosona/path/
...
- **Documentation**: http~/.seosona/path/
- **GitHub Issues**: http~/.seosona/path/
