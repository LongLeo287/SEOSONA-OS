...
```json
{
  "mcpServers": {
    ...
    "postgres": {
      ...
      "env": {
        "DATABASE_URL": "postgresq~/.seosona/path/:pass@localhost:5432/db"
      }
    }
  }
}
...
DATABASE_URL=postgresq~/.seosona/path/:pass@localhost/db
...
- MCP specification: http~/.seosona/path/
