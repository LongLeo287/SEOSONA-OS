...
1. **Create plugins** — commands, agents, hooks, MCP servers, LSP servers (see [Plugins docs](http~/.seosona/path/))
...
- [Plugin Marketplaces](http~/.seosona/path/)
- [Discover Plugins](http~/.seosona/path/)
- [Create Plugins](http~/.seosona/path/)
- [Plugins Reference](http~/.seosona/path/)
- [Plugin Settings](http~/.seosona/path/#plugin-settings)
