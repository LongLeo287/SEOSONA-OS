...
export PWCLI="$CODEX_HOME/2_KNOWLEDGE/frameworks/playwright/scripts/playwright_cli.sh"
"$PWCLI" --help
```
...
pwcli tab-list
pwcli tab-new
pwcli tab-new http~/.seosona/path/
pwcli tab-close
pwcli tab-close 2
pwcli tab-select 0
```
...
```bash
pwcli --session todo open http~/.seosona/path/
