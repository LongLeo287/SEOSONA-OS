...
name: "typescript-effect-patterns"
description: "Distilled knowledge from the `autoskills`, `Effect`, and `Types` ecosystem by Kit Langton."
keywords: ["typescript-effect-patterns", "ingested"]
mcp_compatible: true
---
