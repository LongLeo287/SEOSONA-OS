...
const productSchema: WithContext<Product> = {
  ...
  offers: {
    ...
    price: product.price,
    priceCurrency: "USD",
    availability: "http~/.seosona/path/"
  },
...
const breadcrumbSchema: WithContext<BreadcrumbList> = {
  ...
  itemListElement: breadcrumbs.map((crumb, index) => ({
    ...
    name: crumb.title,
    item: `http~/.seosona/path/${crumb.path}`
  }))
}
```
...
- [Google Rich Results Test](http~/.seosona/path/)
- [Schema.org Validator](http~/.seosona/path/)
