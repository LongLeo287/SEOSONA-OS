---
name: flowsint
description: "Flowsint — open-source OSINT graph-exploration tool for investigations."
version: "1.0.0"
mcp_compatible: true
---
...
source: ingestion_zone/flowsint.md
status: ingested
---

# Flowsint

[![License](http~/.seosona/path/)](./LICENSE)
[![Ethical Software](http~/.seosona/path/)](./ETHICS.md)
[![Buy Me A Coffee](http~/.seosona/path/%20Me%20a%20coffee-support-FFDD00?logo=buy-me-a-coffee&logoColor=black)](http~/.seosona/path/)
[![Ko-fi](http~/.seosona/path/?logo=ko-fi&logoColor=white)](http~/.seosona/path/)
[![Discord](http~/.seosona/path/%20Server-5865F2?logo=discord&logoColor=white)](http~/.seosona/path/)
...
<img width="1439" height="899" alt="hero-dark" src="http~/.seosona/path/" />
...
- [Docker Desktop](http~/.seosona/path/) (make sure it is **running** before the next step)
- Git
...
Then go to [htt~/.seosona/path/:5173/register](htt~/.seosona/path/:5173/register) and create an account. There are no credentials or account by default.
...
Anyone on the network can then access Flowsint at `htt~/.seosona/path/:5173`.
...
**HTTPS (recommended beyond a trusted LAN):** put any reverse proxy in front of port 5173. Example with [Caddy](http~/.seosona/path/):
...
The app is accessible at [htt~/.seosona/path/:5173](htt~/.seosona/path/:5173).
