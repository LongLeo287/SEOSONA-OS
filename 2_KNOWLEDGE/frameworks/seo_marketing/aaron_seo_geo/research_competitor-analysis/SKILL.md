...
summary: "Use when the user asks to analyze competitors or "
description: 'Use when the user asks to "analyze competitors" or ""; benchmarks competitor keywords, content, backlinks, AI citations, and traffic share into strengths, weaknesses, and an action plan. Not for a pairwise topic-coverage gap map — use content-gap-analysis.'
version: "16.0.0"
license: Apache-2.0
