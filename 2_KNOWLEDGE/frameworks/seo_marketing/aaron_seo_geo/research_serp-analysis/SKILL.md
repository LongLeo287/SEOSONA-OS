...
summary: "Use when the user asks to analyze the SERP or SERP"
description: 'Use when the user asks to "analyze the SERP" or "SERP"; maps SERP features, layout, ranking factors, search intent, AI Overviews, and snippet opportunities for a query. Not for keyword demand discovery — use keyword-research.'
version: "16.0.0"
license: Apache-2.0
