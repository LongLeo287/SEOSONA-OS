...
|------|------------------|--------|-----------------------------------|---------------------------|-----------
| **programmatic**"pages at scale", "", pSEO, template × data | A template × dataset system + dedup / indexation rules | A dataset with real per-row facts (not a name/city swap) | Thin/duplicate + index-bloat | [references/programmatic.md](references/programmatic.md)
