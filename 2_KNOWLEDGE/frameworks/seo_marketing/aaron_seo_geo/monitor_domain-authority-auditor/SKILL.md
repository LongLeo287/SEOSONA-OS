...
displayName: "Domain Authority Auditor"
summary: "Use when auditing domain authority, trust, or citation credibility"
description: 'Use when auditing domain authority, trust, or citation credibility; runs 40-item CITE scoring with veto checks (TRUSTED/CAUTIOUS/UNTRUSTED). Not for page-level content quality — use content-quality-auditor; not for backlink profiling alone — use offsite-signal-analyzer.'
version: "16.0.1"
license: Apache-2.0
