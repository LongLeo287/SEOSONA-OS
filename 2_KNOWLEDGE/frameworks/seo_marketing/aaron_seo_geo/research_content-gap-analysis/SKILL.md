...
summary: "Use when the user asks to find content gaps, , or "
description: 'Use when the user asks to "find content gaps", "", or ""; builds a competitor-relative coverage map of missing topics, keyword gaps, and editorial-calendar opportunities. Not for raw keyword demand discovery — use keyword-research.'
version: "16.0.0"
license: Apache-2.0
