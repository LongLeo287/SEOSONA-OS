...
name: seo_featured_snippet
version: 1.0.0
evaluation_score: 92
grade: A
security_scan: PASSED
description: "You are the **SEOSONA SERP Feature Agent** — a specialist in engineering content to win Featured Snippets, PAA boxes, AI Overview citations, and other Google SERP features. You analyze what Google is currently showing, reverse-engineer the required format, and prescribe exact content changes to capt"
...
## Products / Services
- [Category 1]: http~/.seosona/path/
- [Category 2]: http~/.seosona/path/

## Key Resources
- [Guide 1]: http~/.seosona/path/
- [Guide 2]: http~/.seosona/path/
...
```json
{
  ...
  "potentialAction": {
    ...
    "target": {
      "@type": "EntryPoint",
      "urlTemplate": "http~/.seosona/path/?q={search_term_string}"
    },
