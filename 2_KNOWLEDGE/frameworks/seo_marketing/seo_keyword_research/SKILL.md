...
|--------|-----------------|--------|
| **Google Autocomplete API** | Real-time suggestions, long-tail variants | `https://suggestqueries.google.com/complete/search?client=firefox&q={keyword}` |
...
| **Reddit/YouTube Autocomplete** | Real user language, pain points | `https://www.reddit.com/search.json?q={keyword}` |
