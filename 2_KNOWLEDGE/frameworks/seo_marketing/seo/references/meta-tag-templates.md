...
<meta property="og:url" content="http~/.seosona/path/">
...
<meta property="article:author" content="http~/.seosona/path/">
...
<head>
  ...
  <!-- Twitter -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:url" content="http~/.seosona/path/">
...
```bash
# Preview meta tags
curl -s http~/.seosona/path/ | grep -E '<title>|<meta'

# Social media debuggers
# Facebook: http~/.seosona/path/
# Twitter: http~/.seosona/path/
# LinkedIn: http~/.seosona/path/
```
