...
<urlset xmlns="htt~/.seosona/path/">
  <url>
    <loc>http~/.seosona/path/
...
```xml
<?xml version="1.0" encoding="UTF-8"?>
<sitemapindex xmlns="htt~/.seosona/path/">
...
<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="htt~/.seosona/path/"
        xmlns:image="htt~/.seosona/path/">

  <url>
    <loc>http~/.seosona/path/

    <image:image>
      <image:loc>http~/.seosona/path/:loc>
      <image:caption>Image caption</image:caption>
      <image:title>Image title</image:title>
      <image:geo_location>New York, USA</image:geo_location>
      <image:license>http~/.seosona/path/:license>
    </image:image>
...
<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="htt~/.seosona/path/"
        xmlns:video="htt~/.seosona/path/">

  <url>
    <loc>http~/.seosona/path/

    <video:video>
      <video:thumbnail_loc>http~/.seosona/path/:thumbnail_loc>
      <video:title>Video Title</video:title>
      <video:description>Video description (max 2048 chars)</video:description>
      <video:content_loc>http~/.seosona/path/:content_loc>
      <video:player_loc>http~/.seosona/path/?video=123</video:player_loc>
      <video:duration>600</video:duration>
      <video:publication_date>2025-01-15T08:00:00+00:00</video:publication_date>
      <video:family_friendly>yes</video:family_friendly>
      <video:requires_subscription>no</video:requires_subscription>
      <video:uploader info="http~/.seosona/path/">Example Studio</video:uploader>
...
```bash
# Google
curl "http~/.seosona/path/?sitemap=http~/.seosona/path/"
...
app.get('/sitemap.xml', async (req, res) => {
  ...
  <urlset xmlns="htt~/.seosona/path/">
    ${posts.map(post => `
      <url>
        <loc>http~/.seosona/path/${post.slug}</loc>
...
export default async function sitemap() {
  ...
  return [
    {
      url: 'http~/.seosona/path/',
      lastModified: new Date(),
      changeFrequency: 'daily',
      priority: 1,
    },
    ...posts.map(post => ({
      url: `http~/.seosona/path/${post.slug}`,
...
function generate_custom_sitemap() {
  ...
  echo '<urlset xmlns="htt~/.seosona/path/">';
...
- [ ] Absolute URLs (http~/.seosona/path/)
