# Upgrade proposal: welcomyou/sherpa-vietnamese-asr -> seosona-video / asr

- **Fit score:** 49/100
- **Matched evidence:** asr, transcri
- **Source KI:** `knowledge_items/uap_welcomyou_sherpa-vietnamese-asr.md`
