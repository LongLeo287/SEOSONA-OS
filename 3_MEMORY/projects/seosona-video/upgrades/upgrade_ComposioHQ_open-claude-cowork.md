# Upgrade proposal: ComposioHQ/open-claude-cowork -> seosona-video / video-render

- **Fit score:** 44/100
- **Matched evidence:** remotion, render
- **Source KI:** `knowledge_items/uap_ComposioHQ_open-claude-cowork.md`
