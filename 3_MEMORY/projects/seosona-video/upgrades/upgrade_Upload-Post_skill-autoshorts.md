# Upgrade proposal: Upload-Post/skill-autoshorts -> seosona-video / asr

- **Fit score:** 49/100
- **Matched evidence:** whisper, faster-whisper
- **Source KI:** `knowledge_items/uap_Upload-Post_skill-autoshorts.md`
