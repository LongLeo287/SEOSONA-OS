# Upgrade proposal: Bomx/super-video-maker-skill -> seosona-video / video-render

- **Fit score:** 88/100
- **Matched evidence:** ffmpeg, remotion, render, hyperframe
- **Source KI:** `knowledge_items/uap_Bomx_super-video-maker-skill.md`
