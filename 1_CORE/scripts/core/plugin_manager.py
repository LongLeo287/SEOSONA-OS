...
FRAMEWORKS_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "2_KNOWLEDGE", "frameworks"))
ROUTER_FILE = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "2_KNOWLEDGE", "SKILLS_ROUTER.md"))
...
def build_skills_router():
    ...
    for plugin_group in os.listdir(FRAMEWORKS_DIR):
        ...
        # Traverse subdirectories looking for SKILL.md
