...
function checkCapabilityBridge() {
  ...
  try {
    ...
    pass(
      `Capability bridge valid: ${result.resourceCount} resources ` +
      `(${c.skill || 0} skills, ${c.agent || 0} agents, ${c.workflow || 0} workflows, ` +
      `${result.capabilityCount} first-class capabilities)`
    );
  } catch (error) {
