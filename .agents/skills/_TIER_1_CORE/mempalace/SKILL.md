...
id: mempalace
name: Mempalace
description: "MemPalace — the Python package powering SEOSONA's AAAK compressed-memory system (used by the memory-compression daemon to densify logs into knowledge items)."
version: 1.0.0
tier: 3
status: active
