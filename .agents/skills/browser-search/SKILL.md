...
name: browser-search
description: "Web search and browsing for AI agents. Three tools, from lightest to most powerful: SearXNG for search, Camofox for browsing, CloakBrowser for protected sites."
  Web search and browsing for AI agents. Three tools, from lightest to most
  powerful: SearXNG for multi-source search, Camofox for JS-heavy browsing,
  CloakBrowser for protected sites. Operates as a Deep Research engine with
  automatic escalation and exhaustive reporting.
---
